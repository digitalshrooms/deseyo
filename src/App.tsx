...
function LayoutWrapper({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      ...
      {/* Marketing footer (legal links, payment badges, "Začít zdarma") doesn't
          belong once someone's inside the app with the sidebar — it read as a
          jarring mismatch floating next to nav meant for logged-in browsing. */}
      {!isAppNav && <Footer />}
    </div>
  );
}
    ...
    <Router>
      ...
      <LayoutWrapper>
        <Routes>
            ...
            <Route path="/shrnuti" element={<SalesPage />} />
            <Route
              path="/prihlaseni"
              element={
                <PublicRoute>
