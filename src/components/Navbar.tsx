        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <>
              ...
              <motion.aside
                ref={mobileMenuRef}
                className="lg:hidden fixed left-0 top-0 bottom-0 z-50 w-72 max-w-[80vw] flex flex-col rounded-r-2xl overflow-hidden"
                style={glassStyle}
                initial={{ x: '-100%' }}
                animate={{ x: 0 }}
                exit={{ x: '-100%' }}
        ...
        <div className="relative rounded-2xl overflow-hidden" style={glassStyle}>
          <div className="px-4 md:px-5 h-14 sm:h-16 flex items-center justify-between gap-3">
            ...
            <Link
              ...
              onClick={closeMenu}
            >
              <img src="/images/deseyo-logo.png" alt="" className="h-8 sm:h-10" />
              <span
