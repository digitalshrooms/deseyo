          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredCourses.map((course) => (
                ...
                >
                  <div
                    className="relative aspect-video rounded-xl flex items-center justify-center overflow-hidden"
                    style={{ backgroundColor: CARD, border: `1.5px solid var(--primary)` }}
                  >
                  ...
                  <p className="mt-2 text-sm font-normal line-clamp-2 min-h-[2.5em]" style={{ color: 'var(--text)' }}>
